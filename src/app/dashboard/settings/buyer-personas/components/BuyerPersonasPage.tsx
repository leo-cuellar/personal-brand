        ...
        return (
            <div className="flex min-h-screen items-center justify-center">
                <div className="text-center">
                    ...
                    <p className="text-lg text-gray-600">Loading reader personas...</p>
                </div>
            </div>
        );
    }
        ...
        <div className="container mx-auto max-w-6xl p-8">
            ...
            <div className="mb-6">
                <span className="text-sm text-gray-500">
                    {buyerPersonas.length} reader persona{buyerPersonas.length !== 1 ? "s" : ""}
                </span>
            </div>
            ...
            <div className="space-y-6">
                {buyerPersonas.length === 0 ? (
                    ...
                    buyerPersonas.map((persona) => (
                        <div
                            key={persona.id}
                            className={`rounded-lg border p-6 shadow-sm transition-shadow hover:shadow-md ${persona.isArchived
